...
[![logo](https://raw.githubusercontent.com/kodi-iptv-addons/kodi-iptv-addons/master/script.video.iptv.torrenttv/resources/icon.png)](http://torrent-tv.ru)
...
* After installation: 
    ...
    * open **Video Addons**
    * Select and install **TORRENTTV** addon.
...
* После установки репозитория: 
    ...
    * Выбираем и устанавливаем **TORRENTTV** дополнение.
